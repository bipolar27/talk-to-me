import { db } from "@/db";
import { eq, getTableColumns, desc, and, count } from "drizzle-orm";
      ...
      const data = await db
        ...
        .where(
          search
            ...
            : eq(meetings.userId, ctx.auth.user.id) // ✅ bracket fixed here
        )
      ...
      const [total] = await db
        ...
        .where(
          search
            ...
            : eq(meetings.userId, ctx.auth.user.id) // ✅ bracket fixed here too
        );
